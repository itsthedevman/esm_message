...
pub struct PostInit {
    // Set by the client
    #[serde(
        rename(serialize = "ESM_BuildNumber"),
        alias = "ESM_BuildNumber",
        default
    )]
